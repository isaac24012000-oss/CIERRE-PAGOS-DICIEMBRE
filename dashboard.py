...
st.set_page_config(page_title="Dashboard de Pagos Noviembre 2025", layout="wide", initial_sidebar_state="expanded")

# Título principal
st.title("📊 Dashboard de Pagos - Noviembre 2025")

# Cargar datos
@st.cache_data
def cargar_datos():
    excel_file = "PAGOS NOVIEMBRE 2025.xlsx"
    
    # Leer las hojas
    df_cierre = pd.read_excel(excel_file, sheet_name="CIERRE DE PAGOS")
    df_totales = pd.read_excel(excel_file, sheet_name="PAGOS TOTAL SOLO P Y PAGO P Y G")
