...
st.set_page_config(page_title="Dashboard Finanzas - Diciembre 2025", layout="wide", initial_sidebar_state="expanded")

# Título principal
st.title("💰 Dashboard de Finanzas - Diciembre 2025")

# Cargar datos
@st.cache_data
def cargar_datos():
    excel_file = "CIERRE GASTOS ADMINISTRATIVOS DICIEMBRE 2025.xlsx"
...
try:
    ...
    with col_export2:
        ...
        st.download_button(
            ...
            file_name="Datos_Finanzas_Diciembre_2025.xlsx",
    ...
    st.info("Asegúrate de que el archivo 'CIERRE GASTOS ADMINISTRATIVOS DICIEMBRE 2025.xlsx' esté en el mismo directorio que este script.")
